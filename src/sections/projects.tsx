...
function Projects() {
    ...
    const projects = [
        ...
        {projectTitle:"Remote Workers' Welfare", projectLink:"https://github.com/ceabyy/remoteworkersmentalhealth",image:RemoteWorkersPreview, projectHeader:"Understanding remote workers' mental health through data", projectDescription:"Learnt and used Tableau on a Kaggle dataset to investigate how remote workers compare to their non-remote counterparts.", skills:["Data Analysis", "Data Science", "Tableau", "Dashboard Creation"]},
